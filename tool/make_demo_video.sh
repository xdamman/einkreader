...
add 09_reader_highlight.png 2.8
add 10_card_annotate.png 2.2
add 11_share_dialog.png 3.2
add 12_resume.png 2.8
add 13_card_outro.png 3.0
# concat demuxer needs the last file repeated (its duration is ignored).
printf "file '%s/13_card_outro.png'\n" "$PWD/$FRAMES" >>"$list"
